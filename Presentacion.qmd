...
# {background-color="#1A428A" background-image="https://git-scm.com/images/logos/downloads/Git-Logo-2Color.svg"  background-size="60% auto" style="z-index: 4;"}
...
# {background-image="https://miro.medium.com/max/1200/1*dDNpLKu_oTLzStsDTnkJ-g.png" background-color="#1A428A" background-size="60% auto" style="z-index: 4;"}
...
![](img/commits_to_pr.png)

---

![](img/commits_to_pr_github.png)
